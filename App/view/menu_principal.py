...
cadastros.add_cascade(label="Cadastro de Pessoa Física",command=cadastro_cliente_PF)
cadastros.add_cascade(label="Cadastro de Pessoa Jurídica",command=cadastro_cliente_PJ)
